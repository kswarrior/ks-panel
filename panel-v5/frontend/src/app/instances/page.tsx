        ...
        <header className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 border-b border-white/10 pb-8">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-2.5 bg-purple-600 hover:bg-purple-500 text-white font-bold text-sm shadow-lg shadow-purple-600/20 transition-all active:scale-95 border-l border-t border-purple-400"
            >
              <Plus size={18} />
              NEW INSTANCE
            </button>
