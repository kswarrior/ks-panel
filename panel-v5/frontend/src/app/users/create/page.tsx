  ...
  return (
    <div className="pt-2 px-4 lg:px-6 animate-in fade-in duration-500">
      <div className="max-w-4xl mx-auto space-y-4">
        <Link href="/users" className="inline-flex items-center gap-2 text-neutral-400 hover:text-white transition-colors group mb-4">
          <ArrowLeft size={20} className="group-hover:-translate-x-1 transition-transform" />
          Back to Users
        </Link>

        <PageHeader title="Create User" translationKey="createUser" />
