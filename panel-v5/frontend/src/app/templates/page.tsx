        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3 mb-4">
             <div className="relative group flex-1 min-w-[200px] md:min-w-[240px]">
              ...
              <input
                type="text"
                placeholder={t('searchBlueprintsPlaceholder')}
              ...
              <div className="p-6 space-y-4 flex-1">
                 <div className="flex items-start justify-between">
                    ...
                    <div className="text-right">
                       <span className="block text-[10px] font-black text-neutral-500 uppercase tracking-widest">{t('blueprintType')}</span>
                 ...
                 <div>
                    ...
                    <p className="text-xs text-orange-400 font-black tracking-widest mt-2 uppercase">{t('officialBlueprint')}</p>
                 ...
                 <div className="grid grid-cols-2 gap-3">
                    <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/5 border border-white/5">
                       ...
                       <span className="text-[10px] font-bold text-neutral-400 uppercase">{t('scalable')}</span>
                    </div>
                    <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/5 border border-white/5">
                       <Database size={14} className="text-neutral-500" />
                       <span className="text-[10px] font-bold text-neutral-400 uppercase">{t('volSupport')}</span>
                    </div>
                 </div>
              </div>
